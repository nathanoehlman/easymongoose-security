...
module.exports = function (permissions) {
    ...
    return function(schema, options) {
        ...
        /**
          Filters the data exposed to a given access level
         **/
        schema.methods.filterFor = function(role) {
            return restrict(this, role);
        };

        /**
          Updates the object with data given the access level
         **/
        schema.methods.updateWith = function(data, role) {
          return mix(this, data, role);
        };
    };   
}